...
# Load images
RED_SPACE_SHIP = pygame.image.load(os.path.join("assets", "red_ship.png")).convert_alpha()
GREEN_SPACE_SHIP = pygame.image.load(os.path.join("assets", "green_ship.png")).convert_alpha()
BLUE_SPACE_SHIP = pygame.image.load(os.path.join("assets", "blue_ship.png")).convert_alpha()

# Player player
YELLOW_SPACE_SHIP = pygame.image.load(os.path.join("assets", "main_ship.png")).convert_alpha()
